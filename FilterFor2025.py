# ======================================================================================================================
# FilterFor2025.py filters Team Australia members to those matching the following criteria:
    ...
    try:
        for member in club_members:
            ...
            if member not in match:
                ...
                except (KeyError, chessdotcom.errors.ChessDotComClientError):
                    n += 1
                    continue
