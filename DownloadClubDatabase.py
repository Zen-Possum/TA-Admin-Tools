...
if __name__ == '__main__':
    ...
    print(f'Program started. Downloading {N} members into database.')
    n = 1
    last_time = time.time()
    ...
    for member in club_members:
        ...
        df_to_add = pd.DataFrame({'username': [member],
                                  ...
                                  'days_since_online': [round((time.time() - profile['last_online'])/(60*60*24), 1)]
                                  })
    ...
    print(f'Program finished. Database saved as {csv_name}.')
